...
export default {
    ...
    methods:{
        ...
        async getCourse(){
            try {
                const response = await axios.get(`/course/${this.$route.params.CursoImpartidoAdmin}`,this.keyAuth);
                ...
                await axios.get(`/teacherListToQualify/${this.$route.params.CursoImpartidoAdmin}`,this.keyAuth);
                this.availablePDFList = false;
            } catch (error) {
            }
        },

        // Descarga el PDF lista de asistencia
        async getPDFList(){
            try {
                const response = await axios.get(`/course/${this.$route.params.CursoImpartidoAdmin}/assistantList`,this.keyAuth);
